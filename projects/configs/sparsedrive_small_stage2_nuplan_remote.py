...
anno_root = "data_nuplan/infos/" if version == 'trainval' else "data_nuplan/infos/mini/"
...
eval_config = dict(
    **data_basic_config,
    ann_file=anno_root + 'nuplan_infos_val_remote.pkl',
...
data = dict(
    ...
    train=dict(
        **data_basic_config,
        ann_file=anno_root + "nuplan_infos_train.pkl",
